    ...
    <Background>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 pt-24">
        ...
        <div className="w-full max-w-none" style={{ width: '500px' }}>
          ...
          >
            <h1 className="text-3xl font-semibold text-white text-center mb-8 font-afacad">Welcome Back!</h1>
          ...
          <form className="space-y-4" onSubmit={handleLogin}>
            ...
            <div className="text-left mb-6">
              <Link to="#" className="text-black text-xl hover:text-black/80 font-afacad font-medium">
            ...
            {error && <p className="text-red-300 text-lg text-center font-afacad">Error: {error}</p>}
          ...
          <div className="mt-8 text-center">
            <span className="text-black/80 text-lg font-afacad">
              ...
              <Link to="/signup" className="text-black font-bold hover:underline font-afacad text-lg">
                Sign up!
              </Link>
            </span>
          </div>
