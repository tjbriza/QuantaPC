...
export default function Hero() {
  ...
  return (
    <div className='relative h-screen overflow-hidden bg-gray-900'>
      ...
      <div
        className={`absolute inset-0 ${isHovered ? 'animation-paused' : ''}`}
      >
        {/* Large circle - top left - floating pattern */}
        <div
          className='absolute -top-32 -left-32 w-96 h-96 bg-gradient-to-br from-blue-500/50 to-purple-600/40 rounded-full blur-3xl circle-animation'
          style={{ animation: 'float 8s ease-in-out infinite' }}
        ></div>

        {/* Medium circle - top right - orbital pattern */}
        <div
          className='absolute -top-16 -right-24 w-80 h-80 bg-gradient-to-bl from-cyan-400/45 to-blue-500/35 rounded-full blur-3xl circle-animation'
          style={{ animation: 'orbit 15s linear infinite' }}
        ></div>

        {/* Large circle - bottom right - wave pattern */}
        <div
          className='absolute -bottom-40 -right-40 w-[500px] h-[500px] bg-gradient-to-tl from-purple-500/40 to-pink-500/30 rounded-full blur-3xl circle-animation'
          style={{ animation: 'wave 12s ease-in-out infinite' }}
        ></div>

        {/* Medium circle - bottom left - sway pattern */}
        <div
          className='absolute -bottom-20 -left-28 w-72 h-72 bg-gradient-to-tr from-indigo-500/45 to-cyan-400/35 rounded-full blur-3xl circle-animation'
          style={{ animation: 'sway 10s ease-in-out infinite' }}
        ></div>

        {/* Small accent circles - drift pattern */}
        <div
          className='absolute top-1/4 left-1/3 w-48 h-48 bg-gradient-to-r from-emerald-400/40 to-teal-500/30 rounded-full blur-2xl circle-animation'
          style={{ animation: 'drift 18s linear infinite' }}
        ></div>

        {/* Floating circle - orbital pattern (delayed) */}
        <div
          className='absolute top-3/4 right-1/4 w-40 h-40 bg-gradient-to-l from-violet-400/50 to-purple-500/35 rounded-full blur-2xl circle-animation'
          style={{
        ...
        <div
          className='absolute top-1/2 left-1/4 w-32 h-32 bg-gradient-to-br from-rose-400/45 to-pink-500/30 rounded-full blur-xl circle-animation'
          style={{
        ...
        <div
          className='absolute top-1/3 right-1/3 w-24 h-24 bg-gradient-to-bl from-amber-400/40 to-orange-500/25 rounded-full blur-xl circle-animation'
          style={{
            ...
            <div className='space-y-6 pt-20 w-full max-w-3xl'>
              ...
              <div className='h-20 flex items-start'>
                <h2 className='text-2xl md:text-3xl text-white antialiased'>
                  ...
                  <span className='text-white font-bold text-3xl md:text-4xl antialiased'>
                    LOREM IPSUM
                  </span>
                </h2>
              </div>
