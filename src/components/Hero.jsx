        ...
        {slides.map((slide, index) => (
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  'linear-gradient(to top, rgb(0,0,0) 0%, rgb(0,0,0) 15%, rgba(0,0,0,0.9) 25%, rgba(0,0,0,0.6) 35%, rgba(0,0,0,0.3) 45%, transparent 60%)',
              }}
            />
          </div>
        ))}
                ...
                <button
                  ...
                  onMouseEnter={(e) =>
                    (e.target.style.backgroundColor =
                      currentSlide.ctaHoverColor)
                  }
                  onMouseLeave={(e) =>
                    (e.target.style.backgroundColor = currentSlide.ctaColor)
                  }
                >
