        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
          ...
          <div className="p-6 flex flex-col items-center">
            ...
            <div className="w-full max-w-xs">
              ...
              Get your dream rig built exactly how you want it. We offer tailored PC building services using top-tier components for gaming, editing, or everyday use.              </p>
            </div>
          </div>
          ...
          <div className="p-6 flex flex-col items-center">
            ...
            <div className="w-full max-w-md">
              <p className="text-black leading-relaxed text-center">
              Explore our line of high-performance PCs for work, play, or both. Whether you need speed, power, or sleek design — we've got you covered.              </p>
            </div>
          </div>
          ...
          <div className="p-6 flex flex-col items-center">
            <div className="mb-4 w-full max-w-xs">
              ...
              We're here to help every step of the way. From inquiries to after-sales support, our dedicated team ensures a smooth and satisfying experience.              </p>
            </div>
            <div className="w-full max-w-xs">
