...
export default function Navigation() {
  ...
  // Only change colors on homepage, otherwise stay black
  ...
  const hoverBg = isHomepage && !isScrolled 
    ? 'hover:bg-white/10' 
    : 'hover:bg-black/10';
    ...
    <div className='fixed top-0 left-0 right-0 z-50 p-2 md:p-4'>
      <nav className='mx-auto bg-white/20 backdrop-blur-xl rounded-2xl border border-white/20 max-w-[90rem] shadow-[0_0_25px_rgba(0,0,0,0.3)]'>
        <div className='flex items-center justify-between px-4 md:px-8 py-3 md:py-4'>
          ...
          >
            {/* White logo - visible only on homepage when not scrolled */}
            <img
              src='/images/logo.png'
              alt='Quanta PC'
            ...
            />
            {/* Black logo - visible when scrolled or not on homepage */}
            <img
