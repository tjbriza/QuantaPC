...
import { House, Wallet, MapPin, Truck, Settings, LogOut } from 'lucide-react';
...
export default function ProfileWindow({ isOpen, onClose }) {
  ...
  const firstName =
    ...
    'User';
  const lastName =
    profileData?.name_last || user.user_metadata?.last_name || '';
          ...
          >
            ...
            <div className='py-1 bg-[#EEEEEE]'>
              ...
              >
                ...
                <span className="text-[1.1rem] font-['DM_Sans']">
                  Dashboard
                </span>
              </Link>
