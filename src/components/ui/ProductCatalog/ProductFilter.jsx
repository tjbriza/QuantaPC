  ...
  return (
    ...
    >
      <div className="space-y-1.5 lg:space-y-2 xl:space-y-2.5">
        {/* Collection Section */}
        <div>
          <h3 className="font-bold text-sm lg:text-base xl:text-lg mb-1.5 lg:mb-2 text-black cursor-default">
            COLLECTION
          </h3>
          <div className="space-y-0.5 lg:space-y-1">
            <div className="flex items-center justify-between">
              <button className="text-left cursor-pointer text-black text-xs lg:text-sm xl:text-base relative block transition-all duration-300 after:content-[''] after:absolute after:left-0 after:bottom-0 after:h-[0.125rem] after:w-0 after:rounded-full after:bg-gradient-to-r after:from-blue-400 after:to-cyan-300 after:transition-all after:duration-300 hover:after:w-full">
                New Arrival
              </button>
        ...
        {/* Price Range Section */}
        <div>
          <h3 className="font-bold text-sm lg:text-base xl:text-lg text-black mb-1.5 lg:mb-2 cursor-default">
            PRICE RANGE
          </h3>
          <div className="space-y-1.5 lg:space-y-2">
            <div>
              <label className="text-black text-xs lg:text-sm mb-1 block">
                Minimum
              </label>
              <input
                type="text"
