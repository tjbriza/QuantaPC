...
export default function Hero() {
  ...
  return (
    <Background>
      ...
      <div className='max-w-7xl mx-auto px-4 md:px-6 lg:px-2 w-full'>
        <div className='flex flex-col lg:flex-row items-center justify-between h-full'>
          {/* Left Side - Content */}
          <div className='space-y-4 pt-8 md:pt-12 lg:pt-20 w-full max-w-2xl lg:-ml-34 mx-auto lg:mx-0 text-center lg:text-left'>
            {/* Main Headline */}
