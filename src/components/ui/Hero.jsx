        ...
        <div className='flex flex-col lg:flex-row items-center justify-between h-full'>
          ...
          <div className='space-y-4 pt-8 md:pt-12 lg:pt-20 w-full max-w-2xl mx-auto lg:mx-0 lg:ml-8 text-center lg:text-left'>
            ...
            <div className='pt-4 flex justify-center lg:justify-start'>
              <button
                className='bg-[#282E41] hover:bg-[#3A4458] hover:scale-105 transition-all duration-300 group text-white px-6 md:px-8 py-3 md:py-4 rounded-full font-semibold shadow-lg hover:shadow-xl antialiased'
